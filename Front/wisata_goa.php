                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" class="dropdown"><a href="#"><h5>Wisata Alam<i class="fa fa-angle-down"></i></h5></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li class="active"><a href="wisata_goa.php">Danau</a></li>
...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <a><img src="https://i.ibb.co/BVR27cq/DANAU-LAUKAWAR.png" class='img-responsive' alt="DANAU-LAUKAWAR"></a>
                </div>
                <div class="col-sm-6">
                    <p><?php echo "$ket1";  ?></p>
                    <p><?php echo "$ket2";  ?></p>
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <a><img src="https://i.ibb.co/N28MKGK/DANAU-LAUKAWAR-2.png" class='img-responsive' alt="DANAU-LAUKAWAR-2"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/RckTgQf/DANAU-LAUKAWAR-3.png" class='img-responsive' alt="DANAU-LAUKAWAR-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/N6mcNwj/DANAU-LAUKAWAR-4.png" class='img-responsive' alt="DANAU-LAUKAWAR-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/MDbrNGG/DANAU-LAUKAWAR-5.png" class='img-responsive' alt="DANAU-LAUKAWAR-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

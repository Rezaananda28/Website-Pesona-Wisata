...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <a><img src="https://i.ibb.co/bLdQhQQ/AIR-TERJUN-MURSALA-1.png" class='img-responsive' alt="AIR-TERJUN-MURSALA-1"></a>
                </div>
                <div class="col-sm-6">
                    <p><?php echo "$ket1";  ?></p>
                    <p><?php echo "$ket2";  ?></p>
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <a><img src="https://i.ibb.co/d5J7k1P/AIR-TERJUN-MURSALA-2.png" class='img-responsive' alt="AIR-TERJUN-MURSALA-2"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/5rbyd87/AIR-TERJUN-MURSALA-3.png" class='img-responsive' alt="AIR-TERJUN-MURSALA-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/WzB3nMY/AIR-TERJUN-MURSALA-4.png" class='img-responsive' alt="AIR-TERJUN-MURSALA-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/L1qXpfb/AIR-TERJUN-MURSALA-5.png" class='img-responsive' alt="AIR-TERJUN-MURSALA-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

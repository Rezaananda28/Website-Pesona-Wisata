...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <a><img src="https://i.ibb.co/bHSmXtH/BINGKAI-SIBAYAK-1.png" class='img-responsive' alt="BINGKAI-SIBAYAK-1"></a>
                </div>
                <div class="col-sm-6">
                    <p><?php echo "$ket1";  ?></p>
                    <p><?php echo "$ket2";  ?></p>
    ...
    <section id="team">
        <div class="container">
            <div class="row">
                ...
                <p class="text-center wow fadeInDown" data-wow-duration="400ms" data-wow-delay="400ms"> Kumpulan foto dari Gunung Sibayak</p>
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <a><img src="https://i.ibb.co/KVGspj8/BINGKAI-SIBAYAK-2-1.png" class='img-responsive' alt="BINGKAI-SIBAYAK-2-1"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/wNjZFzq/BINGKAI-SIBAYAK-3-1.png" class='img-responsive' alt="BINGKAI-SIBAYAK-3-1" border="0"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/j6btg4F/BINGKAI-SIBAYAK-4-1.png" class='img-responsive' alt="BINGKAI-SIBAYAK-4-1"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/Vp5ckGb/BINGKAI-SIBAYAK-5-1.png" class='img-responsive' alt="BINGKAI-SIBAYAK-5-1"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" class="dropdown"><a href="#"><h5>Wisata Alam<i class="fa fa-angle-down"></i></h5></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li class="active"><a href="wisata_pemandian.php">Laut</a></li>
                            </ul>
                        </li>                    
...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <a><img src="https://i.ibb.co/FmsvyQ3/PULAU-KALIMANTUNG-1.png" class='img-responsive' alt="PULAU-KALIMANTUNG-1"></a>
                </div>
                <div class="col-sm-6">
                    <p><?php echo "$ket1";  ?></p>
                    <p><?php echo "$ket2";  ?></p>
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <a><img src="https://i.ibb.co/tpxssTN/PULAU-KALIMANTUNG-2.png" class='img-responsive' alt="PULAU-KALIMANTUNG-2"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/4FCZDdh/PULAU-KALIMANTUNG-3.png" class='img-responsive' alt="PULAU-KALIMANTUNG-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/H2LshZr/PULAU-KALIMANTUNG-4.png" class='img-responsive' alt="PULAU-KALIMANTUNG-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/TgGPJ7h/PULAU-KALIMANTUNG-5.png" class='img-responsive' alt="PULAU-KALIMANTUNG-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

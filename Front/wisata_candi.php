                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active" class="dropdown"><a><h5>Wisata Edukasi <i class="fa fa-angle-down"></i></h5></a>
                            <ul role="menu" class="sub-menu">
                                ...
                                <li class="active"><a href="wisata_candi.php">Museum</a></li>
...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <a><img src="https://i.ibb.co/D1hHyy5/ISTANA-MAIMUN-1.png" class='img-responsive' alt="ISTANA-MAIMUN-1"></a>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <a><img src="https://i.ibb.co/6P89f3n/ISTANA-MAIMUN-2.png" class='img-responsive' alt="ISTANA-MAIMUN-2"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/9rjQDmm/ISTANA-MAIMUN-3.png" class='img-responsive' alt="ISTANA-MAIMUN-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/1MnkPH4/ISTANA-MAIMUN-4.png" class='img-responsive' alt="ISTANA-MAIMUN-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <a><img src="https://i.ibb.co/SxFHmX1/ISTANA-MAIMUN-5.png" class='img-responsive' alt="ISTANA-MAIMUN-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

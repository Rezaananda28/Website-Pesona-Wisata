...
?>  
    ...
    <section id="company-information" class="padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                <img src="https://i.ibb.co/YXHH55B/TAMAN-SIMALEM-1.png" class='img-responsive' alt="TAMAN-SIMALEM-1"></a>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="item active">
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        ...
                                        <img src="https://i.ibb.co/0MHj78p/TAMAN-SIMALEM-2.png" class='img-responsive' alt="TAMAN-SIMALEM-2"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <img src="https://i.ibb.co/VgJdzBV/TAMAN-SIMALEM-3.png" class='img-responsive' alt="TAMAN-SIMALEM-3"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <img src="https://i.ibb.co/qBhQJXn/TAMAN-SIMALEM-4.png" class='img-responsive' alt="TAMAN-SIMALEM-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="team-single-wrapper">
                                    <div class="team-single">
                                        <div class="person-thumb">
                                        <img src="https://i.ibb.co/SXtT63D/TAMAN-SIMALEM-5.png" class='img-responsive' alt="TAMAN-SIMALEM-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
